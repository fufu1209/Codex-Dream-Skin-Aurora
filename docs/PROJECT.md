...
| 赞助 | Fufu API（`https://fufuapi.xiefucai1209.com`）写在 README 顶部；与换肤配置隔离 |
...
| 改赞助文案 | 同时改 `README.md`、`README.en.md`、`macos/README.md`、`macos/assets/theme.json` 与 `docs/promo-copy.md` |
